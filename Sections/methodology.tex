...
\todo{add technical information, i.e. unity version, major packages used (maze generator), something about the code, and the solution for spawning obstacles in the runner}
