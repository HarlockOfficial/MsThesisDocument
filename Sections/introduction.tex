...
% $\xrightarrow{\text{introduce}}$ MI-based BCI applications in real-world devices (e.g. robotic wheelchairs or prostheses).\\
...
The remainder of this thesis is organised as follows: in Chapter~\ref{ch:related_works}, we discuss the background and related work in the fields of BCI, EEG signal processing, and MI-based applications.
...
% In Chapter \ref{ch:schedule}, we outline the timeline for completing the research and the remaining tasks.
