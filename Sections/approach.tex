...
\begin{figure}[!htbp]
    ...
    The model takes a dataset as input, extracts a sample, generates noise and adds it to the sample, and finally outputs the augmented sample.}\label{fig:noise_injection}
\end{figure}
