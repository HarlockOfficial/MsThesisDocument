...
\end{itemize}
\todo{change item list to a paragraph, like in chapter 4}
...
\todo{add plot with accuracy (y axis), noise (x) axis, to show how accurate was the classification with increasing noise}

\section{Portability}
% How well the system performs on different platforms.
\todo{add to ``other performance metrics'' with properties that I could not verify in this stage of the project}
...
\todo{add to ``other performance metrics''}
