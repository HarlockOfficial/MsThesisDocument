...
\begin{figure}[htbp!]
    ...
    \caption{VR Exergame - A BCI-based exergame for rehabilitation. Image from \cite{trombetta}}
\end{figure}

\begin{figure}[htbp!]
    \centering
    \includegraphics[width=\textwidth]{Figures/Related/ar_app_framework}
    \caption{AR Framework - A framework for the development of AR applications for rehabilitation. Image from \cite{5567156}}
\end{figure}
